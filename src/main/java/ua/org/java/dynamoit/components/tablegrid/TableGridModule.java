...
public class TableGridModule {
    ...
    @Provides
    public TableGridController controller(TableGridContext tableContext, TableGridModel tableModel, DynamoDBService dynamoDBService) {
        return new TableGridController(tableContext, tableModel, dynamoDBService);
    }
